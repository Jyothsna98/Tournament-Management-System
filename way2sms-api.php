...
4  * WAY2SMSClient 
5  * @author Kingster 
6  * @author SuyashBansal 
7  * @category SMS 
8  * Please use this code on your own risk. The author is no way responsible for the outcome arising out of this 
9  * Good Luck! 
10  **/ 
 class WAY2SMSClient 
 { 
...
81      */ 
     ...
     function logout() 
     { 
         curl_setopt($this->curl, CURLOPT_URL, $this->way2smsHost . "LogOut");          curl_setopt($this->curl, CURLOPT_REFERER, $this->refurl); 
         $text = curl_exec($this->curl); 
